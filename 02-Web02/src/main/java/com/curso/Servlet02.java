...
@WebServlet(
		...
		initParams = { 
				@WebInitParam(name = "inicio", value = "67")
		})
...
//         		+ "            <label for=\"nombre\">Servlet01: </label><input type=\"text\" name=\"servlet01\" id=\"servlet01\" value=\"" + request.getParameter("servlet01") + "\">\r\n"
         		+ "            <label for=\"nombre\">Servlet02: </label><input type=\"text\" name=\"servlet02\" id=\"servlet02\">\r\n"
        		+ "        </fieldset>\r\n"
        		+ "\r\n"
        		+ "        <fieldset>\r\n"
        		...
        		+ "            </select>\r\n"
        		+ "        </fieldset>\r\n"
        		+ "			<input type=\"hidden\" name=\"servlet01\" value=\"" + request.getParameter("servlet01") + "\">"
        		+ "\r\n"
        		+ "        <br>\r\n"
